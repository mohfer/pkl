...
<body>
    ...
    <section id="hero" class="container-fluid ungu text-light mb-5 mt-5">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-6">
                <h1 class="fw-bold">Selamat Datang di Aplikasi Inventory Barang dan <br>Keluhan Karyawan Berbasis Web</h1>
    ...
    <section id="about" class="container my-5">
        <div class="row container py-5 my-5 d-flex justify-content-center align-items-center">
            ...
            <div class="col">
                <h1 class="fw-bold title mb-3">Inventory Barang?</h1>
                <p class="text-secondary fs-5">Aplikasi inventory merupakan jenis aplikasi yang berkaitan dengan persediaan barang-barang di gudang. Aplikasi inventory biasanya digunakan oleh suatu perusahaan yang bergerak dalam bisnis agar mampu mengelola barang supaya persediaannya dapat teratur dengan baik.</p>
            </div>
        </div>
    </section>
    <section id="barang" class="container-fluid">
        <div class="container my-5 py-5">
            ...
            <div class="row gap-5 my-5 py-5">
                <div class="col col-barang rounded-3 shadow-lg">
    ...
    <footer class="text-center text-white ungu">
        <div class="container">
            <section class="mt-5">
                <div class="row text-center d-flex justify-content-center pt-5">
                    ...
                    <div class="col-md-2">
                        <h6 class="text-uppercase font-weight-bold">
                            <a href="#table-history" class="text-white">History</a>
                        </h6>
                    </div>
                    <div class="col-md-2">
                        <h6 class="text-uppercase font-weight-bold">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2023 Copyright:
            <a class="text-white" href="https://github.com/Delendins">Delendins</a>
        </div>
    </footer>
</body>
