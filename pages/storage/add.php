...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO storage (id, tipe, kecepatan, kapasitas) VALUES ('$id', '$tipe', '$kecepatan', '$kapasitas')";
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="kecepatan" name="kecepatan" class="form-control" placeholder="600" required>
                                </div>
                                <div class="mb-3">
