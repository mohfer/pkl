                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="tipe_memori" class="form-select" name="tipe_memori" required autocomplete="off">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="kapasitas" name="kapasitas" class="form-control" placeholder="8" required autocomplete="off">
                                </div>
                                <div class="mb-3">
